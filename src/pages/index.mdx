...
<CodeBlock code={typeInferenceCode} lang="typescript" />

### Error Highlighting

<CodeBlock code={errorHighlightingCode} lang="typescript" />

### Custom Configuration

<CodeBlock code={customConfigurationCode} lang="typescript" />
...
Registers the custom web components: `twoslash-root`, `twoslash-trigger`, `twoslash-positioner`, and `twoslash-popup`.
